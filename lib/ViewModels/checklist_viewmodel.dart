...
class ChecklistViewModel extends ChangeNotifier {
  ...
  Future<void> _init() async {
    print('ChecklistViewModel _init called');
    final uid = _auth.currentUser?.uid;
    if (uid == null) {
      print('ChecklistViewModel: uid is null');
      isLoading = false;
      notifyListeners();
      return;
    }
    ...
    print('ChecklistViewModel userIndex exists: ${indexDoc.exists}');
